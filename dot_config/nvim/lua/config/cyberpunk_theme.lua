...
function M.setup()
    ...
    hl(0, "VertSplit", { fg = c.red, bg = "none" })
    hl(0, "WinSeparator", { fg = c.red, bg = "none" })
    hl(0, "StatusLine", { bg = c.sidebar_bg, fg = c.fg })
    hl(0, "StatusLineNC", { bg = c.sidebar_bg, fg = c.comment })
    hl(0, "WinBar", { bg = c.bg, fg = c.red, bold = true })
    hl(0, "WinBarNC", { bg = c.bg, fg = c.comment })
    hl(0, "FloatBorder", { fg = c.red, bg = c.bg })
    hl(0, "FloatTitle", { fg = c.red, bg = c.bg, bold = true })
    ...
    hl(0, "EdgyTitle", { bg = c.active_sidebar_bg, fg = c.red, bold = true })
    ...
    hl(0, "NoiceCmdlinePopupBorder", { fg = c.red, bg = c.bg })
    hl(0, "NoiceCmdlinePopupTitle", { fg = c.red, bg = c.bg, bold = true })
    hl(0, "NoiceCmdline", { bg = c.bg })
    hl(0, "NoiceCmdlineIcon", { fg = c.red, bg = c.bg })
    hl(0, "SnacksNotifierBorder", { fg = c.gold })
    hl(0, "SnacksNotifierTitle", { fg = c.red })
    hl(0, "SnacksPickerBorder", { fg = c.red })
    hl(0, "SnacksPickerTitle", { fg = c.red })

    -- Cmp
    hl(0, "CmpItemAbbrMatch", { fg = c.red, bold = true })
    hl(0, "CmpItemAbbrMatchFuzzy", { fg = c.red, bold = true })
    ...
    -- Alpha
    hl(0, "AlphaHeader", { fg = c.red, bold = true })
